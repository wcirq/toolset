...
__all__ = [
    'UIA_OutlineThicknessPropertyId', 'UIA_HelpTextPropertyId',
    'StructureChangeType_ChildrenReordered',
    'UIA_AnnotationPatternId', 'NotificationProcessing_ImportantAll',
    'WindowInteractionState_NotResponding',
    'UIA_IsStylesPatternAvailablePropertyId',
    'UIA_WindowControlTypeId',
    'UIA_HostedFragmentRootsInvalidatedEventId', 'ScrollAmount',
    'UIA_StylesShapePropertyId', 'TextUnit_Paragraph',
    'UIA_TransformPatternId', 'UIA_TextChildPatternId',
    'UIA_TitleBarControlTypeId', 'WindowInteractionState',
    'StyleId_Heading6', 'UIA_IsTablePatternAvailablePropertyId',
    'SupportedTextSelection_Single',
    'UIA_DropTargetDropTargetEffectsPropertyId', 'LiveSetting',
    'UIA_IsControlElementPropertyId',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'UIA_SpreadsheetItemFormulaPropertyId', 'TreeScope_Subtree',
    'TreeScope_Descendants', 'TextEditChangeType_AutoCorrect',
    'AnnotationType_UnsyncedChange', 'ScrollAmount_NoAmount',
    'AnnotationType_SpellingError',
    'ProviderOptions_UseClientCoordinates',
    'IUIAutomationChangesEventHandler', 'UIA_MenuItemControlTypeId',
    'IUIAutomation5', 'UIA_DropTarget_DragLeaveEventId',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'UIA_StylesFillColorPropertyId',
    'UIA_IsRangeValuePatternAvailablePropertyId', 'TextUnit_Format',
    'WindowInteractionState_Running', 'ScrollAmount_LargeDecrement',
    ...
    'UIA_DataItemControlTypeId', 'UIA_IndentationLeadingAttributeId',
    'UIA_BeforeParagraphSpacingAttributeId',
    'UIA_IsDataValidForFormPropertyId',
    'UIA_ProgressBarControlTypeId',
    'UIA_IsTableItemPatternAvailablePropertyId',
    'NotificationKind_ItemRemoved',
    'UIA_ScrollVerticallyScrollablePropertyId', 'UIA_LinkAttributeId',
    ...
    'UIA_Drag_DragCancelEventId', 'IUIAutomationSelectionPattern',
    'StyleId_Heading9', 'UIA_IsTextChildPatternAvailablePropertyId',
    'ProviderOptions', 'UIA_TableItemPatternId',
    'UIA_LegacyIAccessibleValuePropertyId',
    'UIA_CustomNavigationPatternId',
    'UIA_RangeValueMinimumPropertyId', 'DockPosition_Top',
    'UIA_MenuBarControlTypeId', 'StyleId_Heading2',
    'SynchronizedInputType', 'UIA_GridItemContainingGridPropertyId',
    'UIA_FlowsFromPropertyId', 'TreeTraversalOptions_Default',
    'ProviderOptions_NonClientAreaProvider',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'UIA_NotificationEventId', 'IUIAutomationScrollItemPattern',
    'Off', 'UIA_TextEdit_ConversionTargetChangedEventId',
    'UIA_SpinnerControlTypeId', 'UIA_StatusBarControlTypeId',
    'TextUnit', 'UIA_InvokePatternId', 'UIA_CaretBidiModeAttributeId',
    'UIA_SummaryChangeId', 'UIA_TabItemControlTypeId',
    'NotificationProcessing_CurrentThenMostRecent',
    'UIA_SayAsInterpretAsAttributeId', 'UIA_CapStyleAttributeId',
    ...
    'RowOrColumnMajor_ColumnMajor', 'IUIAutomation6',
    'UIA_DropTargetDropTargetEffectPropertyId', 'UIA_TextPatternId',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'IUIAutomationElement7', 'IUIAutomationDropTargetPattern',
    'IUIAutomationProxyFactory', 'UIA_GridRowCountPropertyId',
    'UIA_DataGridControlTypeId', 'UIA_BoundingRectanglePropertyId',
    'ExpandCollapseState_Expanded', 'NavigateDirection_LastChild',
    'UIA_AnnotationAuthorPropertyId', 'IRawElementProviderSimple',
    'IUIAutomationOrCondition', 'TextUnit_Document',
    'ZoomUnit_SmallIncrement',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'TextEditChangeType_CompositionFinalized',
    'WindowVisualState_Normal', 'NavigateDirection_FirstChild',
    'UIA_WindowCanMinimizePropertyId',
    'UIA_AnnotationDateTimePropertyId', 'ScrollAmount_LargeIncrement',
    'UIA_SayAsInterpretAsMetadataId',
    'UIA_AutomationFocusChangedEventId', 'UIA_ToolBarControlTypeId',
    'UIA_SystemAlertEventId', 'UIA_DragIsGrabbedPropertyId',
    'IUIAutomationValuePattern', 'UIA_Text_TextChangedEventId',
    'TextPatternRangeEndpoint_End', 'UIA_DropTarget_DragEnterEventId',
    'IUIAutomationElement2',
    'UIA_TableItemColumnHeaderItemsPropertyId',
    'UIA_OptimizeForVisualContentPropertyId',
    'UIA_ItemTypePropertyId', 'UIA_FrameworkIdPropertyId',
    'IUIAutomationTransformPattern2', 'UIA_FontWeightAttributeId',
    'NavigateDirection_PreviousSibling',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'UIA_IsTextPattern2AvailablePropertyId',
    'UIA_Transform2ZoomLevelPropertyId', 'NavigateDirection_Parent',
    'UIA_LayoutInvalidatedEventId',
    'StructureChangeType_ChildRemoved',
    'UIA_GridItemColumnPropertyId', 'OrientationType_None',
    'NotificationKind_ActionAborted', 'UIA_IsSuperscriptAttributeId',
    'IUIAutomationStructureChangedEventHandler', 'HeadingLevel1',
    'ExpandCollapseState_LeafNode',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId',
    'DockPosition_None', 'UIA_ActiveTextPositionChangedEventId',
    'AnnotationType_Footer', 'Polite', 'HeadingLevel8',
    'UIA_IsDialogPropertyId',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'IUIAutomationTextRangeArray', 'HeadingLevel4',
    'IUIAutomationTableItemPattern',
    'UIA_AnnotationObjectsPropertyId', 'TreeScope',
    'HeadingLevel_None', 'UIA_ValueValuePropertyId',
    'UIA_HyperlinkControlTypeId', 'UIA_FlowsToPropertyId',
    'UIA_IsActiveAttributeId', 'HeadingLevel3',
    'WindowVisualState_Minimized', 'SupportedTextSelection_None',
    'IUIAutomation4', 'HeadingLevel9',
    'UIA_UnderlineColorAttributeId', 'UIA_HeaderItemControlTypeId',
    'UIA_IsDragPatternAvailablePropertyId',
    'IUIAutomationTextPattern', 'UIA_CalendarControlTypeId',
    ...
    'AnnotationType_DeletionChange', 'UIA_Window_WindowOpenedEventId',
    'UIA_ItemStatusPropertyId', 'UIA_TreeControlTypeId',
    'ExpandCollapseState_Collapsed', 'HeadingLevel7',
    'IUIAutomationProxyFactoryMapping', 'StyleId_Custom',
    'UIA_LiveRegionChangedEventId',
    'UIA_LocalizedControlTypePropertyId',
    'UIA_IsTransformPattern2AvailablePropertyId',
    'UIA_ExpandCollapsePatternId', 'UIA_CultureAttributeId',
    'UIA_LegacyIAccessibleDescriptionPropertyId',
    'WindowInteractionState_BlockedByModalWindow',
    'TreeScope_Ancestors', 'UIA_ScrollPatternId',
    'UIA_AnnotationTypesPropertyId', 'UIA_WindowIsModalPropertyId',
    'UIA_ToolTipControlTypeId',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'UIA_ToolTipOpenedEventId',
    'UIA_IsInvokePatternAvailablePropertyId',
    'UIA_CaretPositionAttributeId', 'UIA_AppBarControlTypeId',
    'UIA_StructureChangedEventId', 'CUIAutomation8',
    'AnnotationType_InsertionChange',
    'UIA_Selection2CurrentSelectedItemPropertyId', 'ToggleState',
    'UIA_RotationPropertyId', 'UIA_AcceleratorKeyPropertyId',
    'IUIAutomationTextEditPattern',
    'UIA_IsSpreadsheetPatternAvailablePropertyId',
    'UIA_GridColumnCountPropertyId', 'StyleId_Heading3',
    'AnnotationType_FormulaError', 'UIA_MainLandmarkTypeId',
    'SupportedTextSelection', 'UIA_DragPatternId',
    'IUIAutomationCustomNavigationPattern',
    'UIA_IsSelectionPattern2AvailablePropertyId',
    'UIA_ClassNamePropertyId',
    'UIA_IsItemContainerPatternAvailablePropertyId',
    'UIA_MenuModeStartEventId', 'StyleId_Subtitle',
    'UIA_DocumentControlTypeId', 'WindowVisualState',
    'CoalesceEventsOptions_Enabled',
    'UIA_AutomationPropertyChangedEventId',
    'UIA_IsGridItemPatternAvailablePropertyId',
    'IUIAutomationCacheRequest', 'IUIAutomationAnnotationPattern',
    'UIA_IsSpreadsheetItemPatternAvailablePropertyId',
    'UIA_OrientationPropertyId', 'UIA_IsContentElementPropertyId',
    'TextEditChangeType_Composition', 'TextEditChangeType_None',
    'Assertive', 'UIA_MarginLeadingAttributeId',
    'NotificationProcessing_ImportantCurrentThenMostRecent',
    'UIA_IsHiddenAttributeId', 'UIA_IsReadOnlyAttributeId',
    'AnnotationType_Author', 'StyleId_Heading7',
    'UIA_ProviderDescriptionPropertyId',
    'IUIAutomationGridItemPattern',
    'UIA_IsKeyboardFocusablePropertyId',
    'ProviderOptions_ProviderOwnsSetFocus',
    'IUIAutomationWindowPattern', 'StyleId_Heading4',
    'UIA_WindowIsTopmostPropertyId',
    'TextEditChangeType_AutoComplete',
    'UIA_SynchronizedInputPatternId', 'StyleId_Heading1',
    'IUIAutomationTablePattern', 'SynchronizedInputType_KeyDown',
    'ProviderOptions_RefuseNonClientSupport', 'IUIAutomationElement9',
    'StyleId_Heading8', 'UIA_Text_TextSelectionChangedEventId',
    'UIA_StylesExtendedPropertiesPropertyId',
    'UIA_MarginBottomAttributeId',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'UIA_FullDescriptionPropertyId', 'UIA_LandmarkTypePropertyId',
    'AnnotationType_Header', 'UIA_DockPatternId',
    'ConnectionRecoveryBehaviorOptions', 'UIA_HeadingLevelPropertyId',
    'UIA_StyleIdAttributeId', 'NotificationKind_Other',
    'UIA_Selection2FirstSelectedItemPropertyId', 'ZoomUnit',
    'UIA_FillColorPropertyId', 'IUIAutomationElement',
    'UIA_AriaRolePropertyId', 'StyleId_BulletedList', 'typelib_path',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId',
    'IUIAutomationItemContainerPattern', 'RowOrColumnMajor_RowMajor',
    'UIA_LiveSettingPropertyId', 'StyleId_Heading5',
    'UIA_LevelPropertyId', 'UIA_IsGridPatternAvailablePropertyId',
    'ProviderOptions_UseComThreading', 'UIA_VirtualizedItemPatternId',
    'NotificationKind_ItemAdded', 'AnnotationType_Endnote',
    'IUIAutomationActiveTextPositionChangedEventHandler',
    'AnnotationType_DataValidationError',
    'PropertyConditionFlags_None', 'ToggleState_On',
    ...
    'IUIAutomationSpreadsheetItemPattern', 'IAccessible',
    'PropertyConditionFlags_MatchSubstring',
    'UIA_Selection2ItemCountPropertyId',
    'UIA_IsMultipleViewPatternAvailablePropertyId',
    'StyleId_Emphasis', 'UIA_TransformPattern2Id',
    'UIA_IndentationTrailingAttributeId', 'StructureChangeType',
    'UIA_StylesStyleIdPropertyId', 'DockPosition_Fill',
    'UIA_LocalizedLandmarkTypePropertyId',
    'IUIAutomationBoolCondition', 'DockPosition',
    'UIA_Invoke_InvokedEventId', 'UIA_CenterPointPropertyId',
    'IUIAutomationSelectionItemPattern', 'AutomationElementMode_Full',
    'UIA_SelectionItemIsSelectedPropertyId',
    'UIA_CustomControlTypeId', 'UIA_MenuModeEndEventId',
    'UIA_ForegroundColorAttributeId', 'TreeScope_Element',
    'IUIAutomationNotCondition',
    'IUIAutomationVirtualizedItemPattern',
    'UIA_TableColumnHeadersPropertyId',
    'UIA_IsTextPatternAvailablePropertyId',
    'IUIAutomationExpandCollapsePattern', 'UIA_StylesPatternId',
    'UIA_WindowWindowVisualStatePropertyId',
    'UIA_WindowCanMaximizePropertyId',
    'UIA_LegacyIAccessibleHelpPropertyId', 'UIA_TableControlTypeId',
    'UIA_ScrollItemPatternId', 'UIA_FontNameAttributeId',
    'UIA_DragDropEffectsPropertyId',
    'UIA_WindowWindowInteractionStatePropertyId',
    'UIA_SizeOfSetPropertyId', 'UIA_BackgroundColorAttributeId',
    'ProviderOptions_ServerSideProvider',
    'UIA_SelectionActiveEndAttributeId', 'UIA_IsSubscriptAttributeId',
    'WindowInteractionState_ReadyForUserInteraction',
    'TreeTraversalOptions_LastToFirstOrder',
    'UIA_ScrollHorizontalScrollPercentPropertyId', 'TextUnit_Word',
    'IUIAutomationRangeValuePattern', 'UIA_SearchLandmarkTypeId',
    'UIA_AccessKeyPropertyId', 'IUIAutomationSelectionPattern2',
    'UIA_IsObjectModelPatternAvailablePropertyId',
    'TreeTraversalOptions_PostOrder', 'IUIAutomationElement6',
    'UIA_AriaPropertiesPropertyId', 'IUIAutomation2',
    'AnnotationType_TrackChanges',
    'ConnectionRecoveryBehaviorOptions_Enabled',
    'UIA_GroupControlTypeId',
    'IUIAutomationPropertyChangedEventHandler',
    'AnnotationType_ConflictingChange',
    'UIA_Drag_DragCompleteEventId', 'UIA_MenuControlTypeId',
    'IUIAutomationTextChildPattern', 'AutomationElementMode',
    'HeadingLevel2', 'UIA_RangeValueValuePropertyId',
    'UIA_MarginTopAttributeId', 'UIA_GridItemRowSpanPropertyId',
    'AutomationElementMode_None', 'WindowInteractionState_Closing',
    'UIA_EditControlTypeId', 'UIA_RangeValueSmallChangePropertyId',
    'NotificationProcessing_ImportantMostRecent',
    'ExpandCollapseState', 'UIA_LegacyIAccessiblePatternId',
    'IUIAutomation3', 'ZoomUnit_SmallDecrement',
    'IUIAutomationDockPattern', 'AnnotationType_Highlighted',
    'IUIAutomationTransformPattern',
    'UIA_AnnotationObjectsAttributeId',
    'IUIAutomationObjectModelPattern',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'IUIAutomationTextRange2', 'DockPosition_Left',
    'IUIAutomationTextEditTextChangedEventHandler',
    'UIA_IsOffscreenPropertyId', 'StyleId_Title', 'CUIAutomation',
    'UIA_IsEnabledPropertyId', 'UIA_Transform2ZoomMaximumPropertyId',
    'UIA_VisualEffectsPropertyId', 'UIA_ProcessIdPropertyId',
    'UIA_NavigationLandmarkTypeId',
    'UIA_HorizontalTextAlignmentAttributeId',
    'ProviderOptions_ClientSideProvider',
    'UIA_IsRequiredForFormPropertyId', 'UIA_ChangesEventId',
    'DockPosition_Right', 'UIA_DockDockPositionPropertyId',
    'UIA_ListItemControlTypeId', 'AnnotationType_GrammarError',
    'UIA_IsValuePatternAvailablePropertyId',
    'AnnotationType_Sensitive', 'UIA_NativeWindowHandlePropertyId',
    'UIA_ScrollVerticalScrollPercentPropertyId',
    'UIA_StrikethroughColorAttributeId', 'UIA_BulletStyleAttributeId',
    'UIA_SelectionPattern2Id', 'AnnotationType_EditingLockedChange',
    'SynchronizedInputType_LeftMouseDown', 'StyleId_NumberedList',
    'HeadingLevel5', 'AnnotationType_ExternalChange',
    'UIA_TogglePatternId', 'StyleId_Normal', 'TreeTraversalOptions',
    'NotificationProcessing_MostRecent', 'AnnotationType_Footnote',
    'UIA_DropTarget_DroppedEventId', 'UIA_MenuClosedEventId',
    'PropertyConditionFlags_IgnoreCase',
    'ScrollAmount_SmallIncrement', 'SynchronizedInputType_KeyUp',
    'TextUnit_Page', 'CoalesceEventsOptions_Disabled',
    'UIA_LegacyIAccessibleStatePropertyId',
    'UIA_IsDropTargetPatternAvailablePropertyId',
    'TextPatternRangeEndpoint_Start', 'TreeScope_Parent',
    'WindowVisualState_Maximized', 'UIA_FormLandmarkTypeId',
    'UIA_RadioButtonControlTypeId', 'UIA_TreeItemControlTypeId',
    'UIA_SelectionItemPatternId', 'UIA_Transform2CanZoomPropertyId',
    'RowOrColumnMajor', 'IUIAutomationTreeWalker',
    'TreeScope_Children', 'SynchronizedInputType_RightMouseDown',
    'UIA_SelectionSelectionPropertyId', 'UIA_TextControlTypeId',
    'ConnectionRecoveryBehaviorOptions_Disabled',
    'UIA_IsDockPatternAvailablePropertyId', 'UIA_IsItalicAttributeId',
    'UIA_ScrollVerticalViewSizePropertyId', 'ZoomUnit_NoAmount',
    'AnnotationType_Unknown', 'UiaChangeInfo',
    'IUIAutomationCondition', 'OrientationType_Vertical',
    'UIA_IsPeripheralPropertyId', 'UIA_GridItemRowPropertyId',
    'IUIAutomationTogglePattern',
    'UIA_StylesFillPatternColorPropertyId',
    'UIA_ToggleToggleStatePropertyId',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'AnnotationType_MoveChange',
    'UIA_IsTogglePatternAvailablePropertyId', 'UIA_TextEditPatternId',
    'IUIAutomationGridPattern', 'UIA_IsPasswordPropertyId',
    'UIA_ListControlTypeId', 'UIA_SplitButtonControlTypeId',
    ...
    'UIA_GridPatternId', 'AnnotationType_AdvancedProofingIssue',
    'IUIAutomationElement4', 'UIA_CulturePropertyId',
    'NavigateDirection_NextSibling', 'UIA_ValueIsReadOnlyPropertyId',
    'UIA_AfterParagraphSpacingAttributeId',
    'UIA_TransformCanResizePropertyId', 'IUIAutomationTextRange3',
    'UIA_Selection2LastSelectedItemPropertyId', 'UIA_TabsAttributeId',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'UIA_FontSizeAttributeId', 'IUIAutomationInvokePattern',
    'UIA_AsyncContentLoadedEventId', 'UIA_AnnotationTargetPropertyId',
    'StructureChangeType_ChildrenBulkAdded',
    'StructureChangeType_ChildAdded', 'UIA_OverlineStyleAttributeId',
    'UIA_TextPattern2Id', 'IUIAutomationEventHandlerGroup',
    'UIA_RangeValuePatternId', 'AnnotationType_FormatChange',
    'IUIAutomationDragPattern', 'ExtendedProperty',
    'UIA_AutomationIdPropertyId', 'ZoomUnit_LargeDecrement',
    ...
    'SynchronizedInputType_LeftMouseUp', 'UIA_StyleNameAttributeId',
    'ZoomUnit_LargeIncrement', 'UIA_SliderControlTypeId',
    'UIA_PositionInSetPropertyId', 'UIA_ClickablePointPropertyId',
    'UIA_OutlineStylesAttributeId', 'UIA_SpreadsheetItemPatternId',
    'UIA_ControllerForPropertyId', 'TextUnit_Line', 'HeadingLevel6',
    'NotificationProcessing_All', 'ProviderOptions_OverrideProvider',
    'NotificationKind', 'UIA_WindowPatternId',
    'IUIAutomationNotificationEventHandler',
    'UIA_StylesFillPatternStylePropertyId',
    'UIA_HasKeyboardFocusPropertyId', 'IUIAutomationTextPattern2',
    'UIA_TableRowHeadersPropertyId', 'UIA_CheckBoxControlTypeId',
    'UIA_SpreadsheetPatternId',
    'UIA_MultipleViewCurrentViewPropertyId', 'IUIAutomation',
    'RowOrColumnMajor_Indeterminate', 'NavigateDirection',
    'StructureChangeType_ChildrenInvalidated',
    'UIA_DescribedByPropertyId', 'UIA_PaneControlTypeId',
    'UIA_RuntimeIdPropertyId', 'UIA_SizePropertyId',
    'IUIAutomationElementArray', 'IUIAutomationTextRange',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId',
    'UIA_TableItemRowHeaderItemsPropertyId',
    'UIA_ScrollBarControlTypeId', 'UIA_LineSpacingAttributeId',
    'UIA_ScrollHorizontalViewSizePropertyId',
    'UIA_Window_WindowClosedEventId',
    'UIA_DragGrabbedItemsPropertyId', 'IUIAutomationScrollPattern',
    'IUIAutomationFocusChangedEventHandler', 'IUIAutomationElement5',
    'AnnotationType_Mathematics', 'SupportedTextSelection_Multiple',
    'IUIAutomationStylesPattern', 'TreeScope_None',
    'PropertyConditionFlags', 'UIA_OverlineColorAttributeId',
    'UIA_GridItemColumnSpanPropertyId', 'TextUnit_Character',
    'UIA_ComboBoxControlTypeId', 'UIA_TransformCanMovePropertyId',
    'UIA_TablePatternId', 'AnnotationType_CircularReferenceError',
    'OrientationType_Horizontal', 'IUIAutomationAndCondition',
    'UIA_AnimationStyleAttributeId', 'UIA_SemanticZoomControlTypeId',
    'ScrollAmount_SmallDecrement',
    'UIA_TextFlowDirectionsAttributeId', 'IUIAutomationElement3',
    'ExpandCollapseState_PartiallyExpanded', 'NotificationProcessing',
    'UIA_IndentationFirstLineAttributeId',
    'UIA_IsScrollPatternAvailablePropertyId',
    'UIA_AnnotationTypesAttributeId', 'TextPatternRangeEndpoint',
    'ToggleState_Off', 'CoalesceEventsOptions',
    'UIA_ButtonControlTypeId', 'UIA_ImageControlTypeId',
    'UIA_InputDiscardedEventId',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'OrientationType', 'UIA_SelectionPatternId', 'Library',
    'UIA_FillTypePropertyId', 'UIA_ValuePatternId',
    'UIA_OutlineColorPropertyId',
    'UIA_RangeValueLargeChangePropertyId',
    'UIA_RangeValueMaximumPropertyId', 'UIA_DropTargetPatternId',
    'IUIAutomationElement8', 'UIA_MenuOpenedEventId',
    ...
    'UIA_InputReachedTargetEventId', 'UIA_HeaderControlTypeId',
    'UIA_ItemContainerPatternId'
]

_check_version('1.4.16', 1788326348.016893)
